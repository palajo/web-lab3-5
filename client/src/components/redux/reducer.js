        ...
        case 'EDIT_ANIMAL':    
            return {    
                ...
                animals: state.animals.map(    
                    (content, i) => content.id === action.payload.id ? {...content, image : action.payload.image ,  title : action.payload.title, description : action.payload.description, dailyPrice : action.payload.dailyPrice }    
                                            : content)    
            };    
        case 'DELETE_ANIMAL':    
            return {    
                ...state,    
                animals: state.animals.filter(item => item.id !== action.payload)    
            };    
        default:    
            return state;    
    }    
